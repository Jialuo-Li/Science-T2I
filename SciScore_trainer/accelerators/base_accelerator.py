...
from accelerators.utils import get_nvidia_smi_gpu_memory_stats_str, print_config, _flatten_dict
...
class BaseAcceleratorConfig:
    _target_: str = "accelerators.base_accelerator.Accelerator"
...
class BaseAccelerator(abc.ABC):
    ...
    def save_checkpoint(self):
        ...
        try:
            ...
            logger.info(f"Failed to save training stage to {save_dir}")
        logger.info(f"Saved checkpoint to {save_dir}")
